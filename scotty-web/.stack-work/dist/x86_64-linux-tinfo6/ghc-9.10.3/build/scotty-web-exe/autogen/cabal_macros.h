...
/* package scotty-web-0.1.0.0 */
#ifndef VERSION_scotty_web
#define VERSION_scotty_web "0.1.0.0"
#endif /* VERSION_scotty_web */
#ifndef MIN_VERSION_scotty_web
#define MIN_VERSION_scotty_web(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_scotty_web */
...
#define CURRENT_COMPONENT_ID "scotty-web-0.1.0.0-2TBvBhtgRLBCJ0SrIN6y8m-scotty-web-exe"
